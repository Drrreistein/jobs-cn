...
- **四象限分析视图** (新增): 结合 AI 风险和就业前景两个维度，将职业分为四类：
  - 🟢 安全增长型：低风险高增长，值得长期投入
  - 🟠 转型增长型：高风险高增长，需要技能升级
  - 🔴 高危衰退型：高风险低增长，建议尽快转型
  - 🔵 稳定停滞型：低风险低增长，当前稳定但有限
...
### 树状图视图
按职业类别展示就业市场结构，矩形大小表示就业人数，颜色表示 AI 暴露度。

![树状图视图](screenshots/treemap.png)

### 暴露度与前景视图
展示同一 AI 风险等级下，各职业的就业前景差异。

![暴露度与前景视图](screenshots/scatter.png)

### 四象限分析视图
结合 AI 风险和就业前景，帮助职业规划决策。

![四象限分析视图](screenshots/quadrant.png)

### 职业搜索与报告
搜索职业并查看详细的 AI 影响分析报告。

![职业搜索与报告](screenshots/query.png)
...
└── screenshots/        # 截图目录
    ├── treemap.png     # 树状图视图截图
    ├── scatter.png     # 暴露度与前景视图截图
    ├── quadrant.png    # 四象限分析视图截图
    └── query.png       # 职业搜索与报告截图
```
